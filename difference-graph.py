...
multiple_of_2 = 0
multiple_of_4 = 0
multiple_of_2_MINUS_multiple_of_4 = 0

prime_array = []
multiple_of_2_MINUS_multiple_of_4_array = []
  ...
  if (isPrime(i) == True):
    ...
    if (len(str(i)) < 15):
      if ((i - 1)%4 == 0):
        ...
        multiple_of_2_MINUS_multiple_of_4 = multiple_of_2_MINUS_multiple_of_4 - 1
      else:
      ...
      if (int(str(i - 1)[len(str(i - 1)) - 2: len(str(i - 1))])%4 == 0):
        ...
        multiple_of_2 = multiple_of_2 + 1
        multiple_of_2_MINUS_multiple_of_4 = multiple_of_2_MINUS_multiple_of_4 + 1
    multiple_of_2_MINUS_multiple_of_4_array.append(multiple_of_2_MINUS_multiple_of_4)

print(f"multiple_of_2: {multiple_of_2}")
print(f"multiple_of_4: {multiple_of_4}")
print(f"multiple_of_2 - multiple_of_4: {multiple_of_2_MINUS_multiple_of_4}")

plt.plot(prime_array, multiple_of_2_MINUS_multiple_of_4_array)
